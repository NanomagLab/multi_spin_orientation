...
def main():
    ...
    Z_END_LIST = [20000, 10000, 20000]
    Z_STEP_LIST = [10000, 5000, 10000]

    save_dir = "figures/figure3b"
    ...
    init_spins = np.stack([r2_spin, r3_spin, s2_spin], axis=0)
